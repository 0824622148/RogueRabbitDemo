...
import GalaxyQuotes from '@/components/journal/GalaxyQuotes'
    ...
    <div style={{ background: '#0F0F10', color: '#E6E6E6', fontFamily: 'var(--font-body)', display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          {/* Radial vignette keeps the heading legible against floating quotes */}
          <div
            style={{
              position: 'absolute',
              inset: '-60px -80px',
              background: 'radial-gradient(ellipse at center, rgba(15,15,16,0.75) 0%, transparent 70%)',
              pointerEvents: 'none',
            }}
          />
      ...
      <Marquee
        items={['THE SQUAD SPEAKS', 'STRAIGHT FIRE', 'DIE KASI APPROVED', 'ROUGE RABBIT']}
        speed={28}
        accent="rouge"
      />
